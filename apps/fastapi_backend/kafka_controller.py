...
class KafkaController:
    ...
    def delete_topics_for_task(self, task_id: str, delay_seconds: int = 60):
        """
            ...
            try:
                ...
                for topic, future in fs.items():
                    try:
                        ...
                        if "unknown topic" in str(e).lower():
                            logger.warning(f"Topic {topic} doesn't exist")
                        else:
